              ...
              <Link to={`/projects/${project._id}`} key={project._id} className="group block">
                <div className="glass-panel rounded-3xl overflow-hidden hover-glow transition-all">
                  <div className="relative h-72 w-full overflow-hidden">
                    <img src={project.coverImage || '/images/house-pool.jpg'} alt={project.name} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"  loading="lazy" />
