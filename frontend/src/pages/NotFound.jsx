  ...
  return (
    <div className="bg-slate-50 min-h-screen text-foreground flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-8 text-center pt-24">
        ...
        <Link 
          to="/"
          className="bg-gradient-to-r from-blue to-blue-light text-white px-4 md:px-8 py-4 rounded-xl font-bold hover-glow transition-all transform duration-300 hover:-translate-y-1"
        >
          Return to Home
        </Link>
      </div>
