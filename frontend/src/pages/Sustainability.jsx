    ...
    <div className="pt-32 pb-24 text-foreground min-h-screen">
      ...
      <section className="py-16 relative z-10">
        ...
        <div className="container mx-auto px-4 md:px-8 text-center max-w-4xl relative z-10">
          <h1 className="text-3xl md:text-5xl font-bold mb-6 text-emerald drop-shadow-sm">Building a Greener Tomorrow</h1>
      ...
      <div className="container mx-auto px-4 md:px-8 max-w-6xl mt-24">
        <div className="grid md:grid-cols-3 gap-8 mb-24">
          ...
          <div className="glass-panel rounded-3xl p-8 text-center hover-scale">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-gold mb-2">12 MW</h3>
