    ...
    <div className="h-screen bg-white text-foreground flex items-center justify-center p-4 overflow-hidden relative">
      ...
      <div className="w-full max-w-[1100px] h-full max-h-[650px] bg-white/90 backdrop-blur-md rounded-[2rem] shadow-[0_8px_30px_rgb(0,0,0,0.08)] border border-slate-200/50 flex flex-col lg:flex-row overflow-hidden relative z-10">
        ...
        <div className="w-full lg:w-[45%] flex flex-col px-8 py-6 md:px-12 md:py-6 justify-center">
          ...
          <div className="mb-2">
            <h1 className="font-title text-[32px] md:text-[36px] font-bold text-gray-900 mb-1 leading-tight tracking-tight">Reset Password</h1>
          </div>
          <p className="text-[13px] text-gray-500 mb-6 font-medium">Enter your admin email and a new password to reset it directly.</p>
          ...
          <form onSubmit={handleReset} className="space-y-3">
            ...
            <div className="bg-[#f5f6f8] rounded-xl px-4 py-2.5 border border-transparent focus-within:border-gray-200 focus-within:bg-white transition-colors relative">
              <label className="block text-[11px] font-bold text-gray-400 mb-0.5">New Password</label>
              <input 
                name="newPassword"
          ...
          <p className="text-center text-[13px] font-bold text-gray-900 mt-5">
            Remembered your password? <Link to="/admin/login" className="text-gray-500 hover:text-gray-900 transition-colors ml-1">Login</Link>
          </p>
